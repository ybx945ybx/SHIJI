...
public class DataKeeper {
    ...
    public void saveDownLoadInfo(SQLDownLoadInfo downloadInfo){
        ...
        cv.put("download", downloadInfo.getDownload());
        cv.put("countryID", downloadInfo.getCountryID());
        cv.put("notUnZip", downloadInfo.getbUnZip());
        cv.put("cityID", downloadInfo.getCityID());
        Cursor cursor = null;
        try{
    ...
    public ArrayList<SQLDownLoadInfo> getAllDownLoadInfo(){
        ...
        while(cursor.moveToNext()){
            ...
            downloadinfo.setTaskID(cursor.getString(cursor.getColumnIndex("taskID")));
            downloadinfo.setUserID(cursor.getString(cursor.getColumnIndex("userID")));
            downloadinfo.setDownload(cursor.getString(cursor.getColumnIndex("download")));
            downloadinfo.setbUnZip(cursor.getString(cursor.getColumnIndex("notUnZip")));
            downloadinfo.setCountryID(cursor.getString(cursor.getColumnIndex("countryID")));
            downloadinfo.setCityID(cursor.getString(cursor.getColumnIndex("cityID")));
