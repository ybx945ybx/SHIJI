...
//				mDeviceCrashInfo.put(VERSION_CODE, pi.versionCode);
                infosMap.put(VERSION_NAME, pi.versionName == null ? "not set" : pi.versionName);
                infosMap.put(VERSION_CODE, String.valueOf(pi.versionCode));
            }
...
//				mDeviceCrashInfo.put(field.getName(), field.get(null));
                infosMap.put(field.getName(), String.valueOf(field.get(null)));
                if (DEBUG) {
...
//		mDeviceCrashInfo.put(STACK_TRACE, result);
        ...
        String rootPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/shiji/crash";
