...
public class ShareUtils {
    ...
    public static void share9PicToFriendNoSDK(Context context, String Kdescription, List<String> paths) {
        if(!isInstallWeChart(context)){
            Toast.makeText(context,"您没有安装微信",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        ((SelectForwardedGoodsActivity)context).startActivityForResult(intent, 111);
    }
