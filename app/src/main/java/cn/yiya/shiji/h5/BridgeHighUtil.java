...
public class BridgeHighUtil {
    ...
    final static String JS_HANDLE_MESSAGE_FROM_JAVA_NO_PREFIX = "WebViewJavascriptBridge._handleMessageFromNative('%s');";
    final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:WebViewJavascriptBridge._fetchQueue();";
    final static String JS_FETCH_QUEUE_FROM_JAVA_NO_PREFIX = "WebViewJavascriptBridge._fetchQueue();";
    public final static String JAVASCRIPT_STR = "javascript:";

    public static String parseFunctionName2(String jsUrl){
        return jsUrl.replace("WebViewJavascriptBridge.", "").replaceAll("\\(.*\\);", "");
    }
